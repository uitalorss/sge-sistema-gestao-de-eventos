...
@router.post("/inscricao", response_model=InscricaoSchema, status_code=status.HTTP_201_CREATED)
...
@router.delete("/inscricao/{evento_id}", status_code=status.HTTP_204_NO_CONTENT)
