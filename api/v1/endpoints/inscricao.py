...
from utils.errors.error_responses import auth_responses, inscricao_responses, not_found_inscricao_response

router = APIRouter()

@router.post("/", response_model=InscricaoSchema, status_code=status.HTTP_201_CREATED, responses={**auth_responses, **inscricao_responses})
...
@router.delete("/{evento_id}", status_code=status.HTTP_204_NO_CONTENT, responses={**auth_responses, **not_found_inscricao_response})
